...
public class AURecipes {
    ...
    public static final DeferredRegister<RecipeBookCategory> CATEGORIES = DeferredRegister.create(Registries.RECIPE_BOOK_CATEGORY, AuxiliaUtilities.MODID);
    ...
    public static final DeferredHolder<RecipeBookCategory, RecipeBookCategory> RESONATOR_CATEGORY = CATEGORIES.register(ResonatorRecipe.Type.ID, RecipeBookCategory::new);
    ...
    public static final DeferredHolder<RecipeBookCategory, RecipeBookCategory> ENCHANTER_CATEGORY = CATEGORIES.register(EnchanterRecipe.Type.ID, RecipeBookCategory::new);
    ...
    public static final DeferredHolder<RecipeBookCategory, RecipeBookCategory> CRUSHER_CATEGORY = CATEGORIES.register(CrusherRecipe.Type.ID, RecipeBookCategory::new);
